...
1. Make sure you have a GitLab account
  and that you have [set up SSH key pair for authentication with GitLab](../learners/installation-instructions.md#secure-access-to-gitlab-using-git-from-command-line).
